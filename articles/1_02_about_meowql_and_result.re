...
//image[students_sql][参加者の書いたSQLたち]{
//}
...
ですので、会社の書棚にあった@<href>{https://gihyo.jp/book/2016/978-4-7741-8066-3,「改訂第3版 すらすらと手が動くようになる SQL書き方ドリル」}を使うことにしました。



//image[sql_drill][改訂第3版 すらすらと手が動くようになる SQL書き方ドリル]{
//}
